VERSION 5.00
Begin VB.Form SinglePlayer 
   BackColor       =   &H00FFFFFF&
   Caption         =   "Ludo Snake And Ladders"
   ClientHeight    =   6705
   ClientLeft      =   2955
   ClientTop       =   2055
   ClientWidth     =   8265
   Icon            =   "Single Player.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Picture         =   "Single Player.frx":1272
   ScaleHeight     =   6705
   ScaleWidth      =   8265
   ...
   Begin VB.Image imgTrophy 
      Height          =   2175
      Left            =   2835
      Picture         =   "Single Player.frx":855B4
      Stretch         =   -1  'True
      Top             =   2460
      Visible         =   0   'False
      Width           =   1455
   ...
   Begin VB.Image imgDice 
      ...
      Index           =   1
      Left            =   6780
      Picture         =   "Single Player.frx":86681
      Stretch         =   -1  'True
      Top             =   1965
      Visible         =   0   'False
      Width           =   1050
   ...
   Begin VB.Image imgDice 
      ...
      Index           =   2
      Left            =   6750
      Picture         =   "Single Player.frx":88969
      Stretch         =   -1  'True
      Top             =   1965
      Visible         =   0   'False
      Width           =   1050
   ...
   Begin VB.Image imgDice 
      ...
      Index           =   3
      Left            =   6750
      Picture         =   "Single Player.frx":8C194
      Stretch         =   -1  'True
      Top             =   1965
      Visible         =   0   'False
      Width           =   1050
   ...
   Begin VB.Image imgDice 
      ...
      Index           =   4
      Left            =   6750
      Picture         =   "Single Player.frx":8EA70
      Stretch         =   -1  'True
      Top             =   1965
      Visible         =   0   'False
      Width           =   1050
   ...
   Begin VB.Image imgDice 
      ...
      Index           =   5
      Left            =   6750
      Picture         =   "Single Player.frx":917F3
      Stretch         =   -1  'True
      Top             =   1965
      Visible         =   0   'False
      Width           =   1050
   ...
   Begin VB.Image imgDice 
      ...
      Index           =   6
      Left            =   6750
      Picture         =   "Single Player.frx":946A8
      Stretch         =   -1  'True
      Top             =   1965
      Visible         =   0   'False
      Width           =   1050
   ...
   End
End
Attribute VB_Name = "SinglePlayer"
